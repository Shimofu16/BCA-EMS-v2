...
@section('css')
    <style>
        ...
        .academics-bg {
            position: relative;
            /* add this */
            background-image: url("/assets/img/students/lower elem.jpg");
            width: 100%;
            height: 100%;
                        ...
                        <div class="card card-h mb-3">
                            <div class="card-body academics-bg card-img">
                                <div class="academics-bg-overlay card-img">
                                    <h2 class="text-white">Elementary</h2>
                                    <p class="text-white text-center">The goal of elementary education is to provide
                                        students
                                        with a strong
                                        foundation for future learning and to help them develop critical thinking and
